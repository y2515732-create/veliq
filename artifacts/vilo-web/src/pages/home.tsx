...
export default function Home() {
  ...
  return (
    <div style={{ background: "#000", minHeight: "100vh", color: "#fff", fontFamily: "monospace", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "20px" }}>
      ...
      <div style={{ background: "#111", border: "1px solid #00ff88", borderRadius: "4px", padding: "8px 20px", marginBottom: "40px", fontSize: "12px", color: "#00ff88", letterSpacing: "2px" }}>
        ● LIVE
      </div>
      ...
      <div style={{ width: "100%", maxWidth: "400px", display: "flex", flexDirection: "column", gap: "12px", marginBottom: "20px" }}>
        <input
          ...
          style={{ background: "#111", border: "1px solid #333", color: "#fff", padding: "16px", fontSize: "14px", letterSpacing: "2px", outline: "none" }}
        />
        <input
        ...
        <button
          ...
          style={{ background: "#00ff88", color: "#000", border: "none", padding: "20px", fontSize: "16px", fontWeight: "900", letterSpacing: "2px", cursor: "pointer" }}
        >
